  ...
  return (
    <section className="min-h-screen bg-gray-50 text-gray-800 py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-6 text-indigo-700">Sobre Nosotros</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          <div className="bg-white shadow-md rounded-2xl p-8">
            <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Nuestra Misión</h3>
          ...
          <div className="bg-white shadow-md rounded-2xl p-8">
            <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Nuestra Visión</h3>
            <p className="text-gray-600">
        ...
        <h3 className="text-3xl font-bold mb-8 text-indigo-700">Nuestros Espacios</h3>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-lg transition">
            <BookOpen className="mx-auto text-indigo-600 w-10 h-10 mb-4" />
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-lg transition">
            <Users className="mx-auto text-indigo-600 w-10 h-10 mb-4" />
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-lg transition">
            <Coffee className="mx-auto text-indigo-600 w-10 h-10 mb-4" />
